...
Below are the steps to configure the [pipelines](https://github.com/teamapp/flutter-supabase-production-template/tree/main/.github/workflows) to create a deployment preview, deploy Supabase edge functions, and create / publish releases.
...
:::info
You'd preferably configure a subdomain (e.g. `app.teamapp.com`)
:::
...
2. Run the [bumpversion.sh](https://github.com/teamapp/flutter-supabase-production-template/blob/main/flutter/bumpversion.sh) script and specify the version number
